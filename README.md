...
2. A szükséges részeket az `ha_mg_zs_ev.yaml` fájlból másold be.
3. Kösd össze az ESP32-t a géppel
4. Flash-eld az ESP32-re az [ESPHome Web Tools](https://web.esphome.io/) vagy a Home Assistant ESPHome kiegészítője segítségével.
5. Az ESPHome Builder kezelőfelületén online lesz és használd az új entitásokat.
